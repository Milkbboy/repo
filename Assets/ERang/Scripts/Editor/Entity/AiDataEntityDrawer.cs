...
namespace ERang
{
    ...
    public class AiDataEntityDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            // Ai_Id 값을 가져옵니다.
            SerializedProperty idProperty = property.FindPropertyRelative("Ai_Id");
            if (idProperty == null)
            {
                EditorGUI.LabelField(position, "Id: SerializedProperty is null");
                EditorGUI.EndProperty();
                return;
            }
            string cardId = idProperty.intValue.ToString();
