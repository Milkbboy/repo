...
namespace ERang
{
    [CustomEditor(typeof(ConditionDataTable))]
    public class ConditionDataTableEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("Condition Data Table", EditorStyles.boldLabel);
